(() => {
  ...
  const lightSrc = `${base}/assets/jcge_agentinterface_logo_light.png`;
  const darkSrc = `${base}/assets/jcge_agentinterface_logo_dark.png`;
  ...
  const applyLogo = () => {
    ...
    if (!logoImg) {
      ...
      logoImg.alt = "JCGE AgentInterface logo";
